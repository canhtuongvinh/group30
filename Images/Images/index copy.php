...
/* The following 4 code lines contain the database connection information. Alternatively, you can move these code lines to a separate file and include the file here. You can also modify this code based on your database connection. */
	 if($Table = "complianceauditor"){
		$DataType1 = "SELECT 'No.60PlusScoredAspects' FROM 'complianceauditor'";
		$DataType2 = "SELECT 'No12PlusScoreHazardsPerClient' FROM 'complianceauditor'";
		$DataType3 = "SELECT 'NoClimateRisks' FROM 'complianceauditor'";
		$DataType4 = "SELECT 'NoClimateOpportunities' FROM 'complianceauditor'";
	 }
